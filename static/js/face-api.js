(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    // LABEL EKSPRESI
    var FACE_EXPRESSION_LABELS = ['Datar', 'Senang', 'Sedih', 'Marah', 'Takut', 'Jijik', 'Terkejut'];
    ...
    var DrawFaceLandmarksOptions = /** @class */ (function () {
        function DrawFaceLandmarksOptions(options) {
            if (options === void 0) { options = {}; }
            // LANDMARK WAJAH
            var _a = options.drawLines, drawLines = _a === void 0 ? false : _a,
                _b = options.drawPoints, drawPoints = _b === void 0 ? false : _b,
                lineWidth = options.lineWidth, lineColor = options.lineColor,
                pointSize = options.pointSize, pointColor = options.pointColor;
